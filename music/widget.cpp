...
void Widget::ZhuanTaiPanDuan()
{
    if (QMediaPlayer::PlaybackState::StoppedState == mediaPlayer->playbackState()) //  停止状态
    {
        ui->pushButton_4->setStyleSheet("QPushButton{border:none;image: url(:/tubiao/player01.png);}");
    }
    else if (QMediaPlayer::PlaybackState::PlayingState == mediaPlayer->playbackState()) //  播放状态
    {
        ui->pushButton_4->setStyleSheet("QPushButton{border:none;image: url(:/tubiao/pause01.png);}");
    }
    else if (QMediaPlayer::PlaybackState::PausedState == mediaPlayer->playbackState()) //  停止状态
    {
        ui->pushButton_4->setStyleSheet("QPushButton{border:none;image: url(:/tubiao/player01.png);}");
    }
}
