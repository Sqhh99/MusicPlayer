...
QtObject {
    ...
    readonly property color materialButtonBg: "#52FFFFFF"
    readonly property color materialButtonHoverBg: "#74FFFFFF"
    readonly property color materialButtonPressedBg: "#8CFFFFFF"
    readonly property color materialButtonBorder: "#66FFFFFF"
    readonly property color materialButtonActiveBg: "#A8EFF6FF"
    readonly property color materialPrimaryButtonBg: "#A6FFFFFF"
    readonly property color materialPrimaryButtonHoverBg: "#C2FFFFFF"
    readonly property color materialPrimaryButtonPressedBg: "#D8FFFFFF"
    readonly property color materialPrimaryButtonBorder: "#7DFFFFFF"
